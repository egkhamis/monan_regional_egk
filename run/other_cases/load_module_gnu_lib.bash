...
export PIO='/mnt/beegfs/monan/libs_openmpi/pio'
export HDF_DIR=/mnt/beegfs/monan/libs_openmpi/hdf5
...
export PATH=${PATH}:/mnt/beegfs/paulo.kubota/lib/openjpeg:/mnt/beegfs/monan/libs_openmpi/netcdf/bin:/mnt/beegfs/monan/libs_openmpi/hdf5:/mnt/beegfs/monan/libs_openmpi/hdf5/bin
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/mnt/beegfs/paulo.kubota/lib/grib2/lib:/mnt/beegfs/paulo.kubota/lib/openjpeg/lib:/mnt/beegfs/paulo.kubota/lib/grib2/lib:/mnt/beegfs/paulo.kubota/lib/libaec/libaec-v0.3.2/lib:/mnt/beegfs/monan/libs_openmpi/hdf5/lib:/mnt/beegfs/monan/libs_openmpi/hdf5/include:/mnt/beegfs/monan/libs_openmpi/netcdf/lib:/mnt/beegfs/monan/libs_openmpi/netcdf/include
