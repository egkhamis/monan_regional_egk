#!/bin/bash -x
function Function_Create_ctl.clm() {
#-----------------------------------------------------------------------------#
#                                   DIMNT/INPE                                #
#-----------------------------------------------------------------------------#
#BOP
...
agrdflx=>agrdflx            0   t,y,x Time Mean  ground heat flux  [W m^{-2}]
ivgtyp=>ivgtyp              0     y,x  dominant vegetation category
isltyp=>isltyp              0     y,x  dominate soil category
sst=>sst                    0   t,y,x  sea-surface temperature
xice=>xice                  0   t,y,x  fractional area coverage of sea-ice
xland=>xland                0   t,y,x  land-ocean mask (1=land including sea-ice ; 2=ocean) 
...
azwtxy=>azwtxy              0   t,y,x  Time Mean water table depth [m]
awaxy=>awaxy                0   t,y,x  Time Mean water storage in aquifer [mm]
awtxy=>awtxy                0   t,y,x  Time Mean water storage in aquifer + saturated soil[mm]
awslakexy=>awslakexy        0   t,y,x  Time Mean water storage in lake (can be negative)[mm]
adeeprechxy=>adeeprechxy    0   t,y,x  Time Mean  groundwater recharge to or from the water table when deep[m]
arechxy=>arechxy            0   t,y,x  Time Mean  groundwater recharge to or from shallow water table [mm]
